...
type Tenant struct {
	...
	Informacoesdecontato null.String `boil:"informacoesdecontato" json:"informacoesdecontato,omitempty" toml:"informacoesdecontato" yaml:"informacoesdecontato,omitempty"`
...
var TenantColumns = struct {
	...
	Tenantid:             "tenantid",
	Nome:                 "nome",
	Informacoesdecontato: "informacoesdecontato",
}
...
var TenantTableColumns = struct {
	...
	Nome:                 "tenant.nome",
	Informacoesdecontato: "tenant.informacoesdecontato",
}
...
var TenantWhere = struct {
	...
	Informacoesdecontato whereHelpernull_String
}{
	Tenantid:             whereHelperint{field: "\"tenant\".\"tenantid\""},
	Nome:                 whereHelperstring{field: "\"tenant\".\"nome\""},
	Informacoesdecontato: whereHelpernull_String{field: "\"tenant\".\"informacoesdecontato\""},
}

// TenantRels is where relationship names are stored.
var TenantRels = struct {
	TenantidEventos    string
	TenantidTickets    string
	TenantidTransacaos string
	TenantidUsuarios   string
}{
	TenantidEventos:    "TenantidEventos",
	TenantidTickets:    "TenantidTickets",
	TenantidTransacaos: "TenantidTransacaos",
	TenantidUsuarios:   "TenantidUsuarios",
}

// tenantR is where relationships are stored.
type tenantR struct {
	TenantidEventos    EventoSlice    `boil:"TenantidEventos" json:"TenantidEventos" toml:"TenantidEventos" yaml:"TenantidEventos"`
	TenantidTickets    TicketSlice    `boil:"TenantidTickets" json:"TenantidTickets" toml:"TenantidTickets" yaml:"TenantidTickets"`
	TenantidTransacaos TransacaoSlice `boil:"TenantidTransacaos" json:"TenantidTransacaos" toml:"TenantidTransacaos" yaml:"TenantidTransacaos"`
	TenantidUsuarios   UsuarioSlice   `boil:"TenantidUsuarios" json:"TenantidUsuarios" toml:"TenantidUsuarios" yaml:"TenantidUsuarios"`
}
...
func (r *tenantR) GetTenantidEventos() EventoSlice {
	if r == nil {
		return nil
	}
	return r.TenantidEventos
}

func (r *tenantR) GetTenantidTickets() TicketSlice {
	if r == nil {
		return nil
	}
	return r.TenantidTickets
}

func (r *tenantR) GetTenantidTransacaos() TransacaoSlice {
	if r == nil {
		return nil
	}
	return r.TenantidTransacaos
}

func (r *tenantR) GetTenantidUsuarios() UsuarioSlice {
	if r == nil {
		return nil
	}
	return r.TenantidUsuarios
}
...
var (
	tenantAllColumns            = []string{"tenantid", "nome", "informacoesdecontato"}
	tenantColumnsWithoutDefault = []string{"nome"}
	tenantColumnsWithDefault    = []string{"tenantid", "informacoesdecontato"}
	tenantPrimaryKeyColumns     = []string{"tenantid"}
...
// TenantidEventos retrieves all the evento's Eventos with an executor via tenantid column.
func (o *Tenant) TenantidEventos(mods ...qm.QueryMod) eventoQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"evento\".\"tenantid\"=?", o.Tenantid),
	)

	return Eventos(queryMods...)
}

// TenantidTickets retrieves all the ticket's Tickets with an executor via tenantid column.
func (o *Tenant) TenantidTickets(mods ...qm.QueryMod) ticketQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"ticket\".\"tenantid\"=?", o.Tenantid),
	)

	return Tickets(queryMods...)
}

// TenantidTransacaos retrieves all the transacao's Transacaos with an executor via tenantid column.
func (o *Tenant) TenantidTransacaos(mods ...qm.QueryMod) transacaoQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"transacao\".\"tenantid\"=?", o.Tenantid),
	)

	return Transacaos(queryMods...)
}

// TenantidUsuarios retrieves all the usuario's Usuarios with an executor via tenantid column.
func (o *Tenant) TenantidUsuarios(mods ...qm.QueryMod) usuarioQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"usuario\".\"tenantid\"=?", o.Tenantid),
	)

	return Usuarios(queryMods...)
}

// LoadTenantidEventos allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (tenantL) LoadTenantidEventos(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTenant interface{}, mods queries.Applicator) error {
	var slice []*Tenant
	var object *Tenant
	...
	query := NewQuery(
		qm.From(`evento`),
		qm.WhereIn(`evento.tenantid in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.TenantidEventos = resultSlice
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.Tenantid == foreign.Tenantid {
				local.R.TenantidEventos = append(local.R.TenantidEventos, foreign)
				if foreign.R == nil {
					foreign.R = &eventoR{}
				}
...
// LoadTenantidTickets allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (tenantL) LoadTenantidTickets(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTenant interface{}, mods queries.Applicator) error {
	var slice []*Tenant
	var object *Tenant
	...
	query := NewQuery(
		qm.From(`ticket`),
		qm.WhereIn(`ticket.tenantid in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.TenantidTickets = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &ticketR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.Tenantid == foreign.Tenantid {
				local.R.TenantidTickets = append(local.R.TenantidTickets, foreign)
				if foreign.R == nil {
					foreign.R = &ticketR{}
				}
				foreign.R.TenantidTenant = local
...
// LoadTenantidTransacaos allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (tenantL) LoadTenantidTransacaos(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTenant interface{}, mods queries.Applicator) error {
	var slice []*Tenant
	var object *Tenant
	...
	query := NewQuery(
		qm.From(`transacao`),
		qm.WhereIn(`transacao.tenantid in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.TenantidTransacaos = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.Tenantid == foreign.Tenantid {
				local.R.TenantidTransacaos = append(local.R.TenantidTransacaos, foreign)
				if foreign.R == nil {
					foreign.R = &transacaoR{}
				}
				foreign.R.TenantidTenant = local
...
// LoadTenantidUsuarios allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (tenantL) LoadTenantidUsuarios(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTenant interface{}, mods queries.Applicator) error {
	var slice []*Tenant
	var object *Tenant
	...
	query := NewQuery(
		qm.From(`usuario`),
		qm.WhereIn(`usuario.tenantid in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.TenantidUsuarios = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &usuarioR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.Tenantid == foreign.Tenantid {
				local.R.TenantidUsuarios = append(local.R.TenantidUsuarios, foreign)
				if foreign.R == nil {
					foreign.R = &usuarioR{}
				}
				foreign.R.TenantidTenant = local
...
// AddTenantidEventos adds the given related objects to the existing relationships
// of the tenant, optionally inserting them as new records.
// Appends related to o.R.TenantidEventos.
// Sets related.R.TenantidTenant appropriately.
func (o *Tenant) AddTenantidEventos(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Evento) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.Tenantid = o.Tenantid
			...
			values := []interface{}{o.Tenantid, rel.Eventoid}
	...
	if o.R == nil {
		o.R = &tenantR{
			TenantidEventos: related,
		}
	} else {
		o.R.TenantidEventos = append(o.R.TenantidEventos, related...)
	}
...
// AddTenantidTickets adds the given related objects to the existing relationships
// of the tenant, optionally inserting them as new records.
// Appends related to o.R.TenantidTickets.
// Sets related.R.TenantidTenant appropriately.
func (o *Tenant) AddTenantidTickets(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Ticket) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.Tenantid = o.Tenantid
			...
			values := []interface{}{o.Tenantid, rel.Ticketid}
	...
	if o.R == nil {
		o.R = &tenantR{
			TenantidTickets: related,
		}
	} else {
		o.R.TenantidTickets = append(o.R.TenantidTickets, related...)
	}
...
// AddTenantidTransacaos adds the given related objects to the existing relationships
// of the tenant, optionally inserting them as new records.
// Appends related to o.R.TenantidTransacaos.
// Sets related.R.TenantidTenant appropriately.
func (o *Tenant) AddTenantidTransacaos(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Transacao) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.Tenantid = o.Tenantid
			...
			values := []interface{}{o.Tenantid, rel.Transacaoid}
	...
	if o.R == nil {
		o.R = &tenantR{
			TenantidTransacaos: related,
		}
	} else {
		o.R.TenantidTransacaos = append(o.R.TenantidTransacaos, related...)
	}
...
// AddTenantidUsuarios adds the given related objects to the existing relationships
// of the tenant, optionally inserting them as new records.
// Appends related to o.R.TenantidUsuarios.
// Sets related.R.TenantidTenant appropriately.
func (o *Tenant) AddTenantidUsuarios(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Usuario) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.Tenantid = o.Tenantid
			...
			values := []interface{}{o.Tenantid, rel.Userid}
	...
	if o.R == nil {
		o.R = &tenantR{
			TenantidUsuarios: related,
		}
	} else {
		o.R.TenantidUsuarios = append(o.R.TenantidUsuarios, related...)
	}
...
func FindTenant(ctx context.Context, exec boil.ContextExecutor, tenantid int, selectCols ...string) (*Tenant, error) {
	tenantObj := &Tenant{}
	...
	query := fmt.Sprintf(
		"select %s from \"tenant\" where \"tenantid\"=$1", sel,
	)
...
func (o *Tenant) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"tenant\" WHERE \"tenantid\"=$1"
...
func (o *Tenant) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindTenant(ctx, exec, o.Tenantid)
	if err != nil {
		return err
	}
...
func TenantExists(ctx context.Context, exec boil.ContextExecutor, tenantid int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"tenant\" where \"tenantid\"=$1 limit 1)"
...
func (o *Tenant) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return TenantExists(ctx, exec, o.Tenantid)
}
