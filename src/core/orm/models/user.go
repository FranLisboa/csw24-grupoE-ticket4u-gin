...
var UserWhere = struct {
	...
	Description:  whereHelperstring{field: "\"user\".\"description\""},
...
var (
	userAllColumns            = []string{"id", "name", "description", "address", "phone", "email", "password_hash"}
	userColumnsWithoutDefault = []string{"name", "description", "address", "phone", "email", "password_hash"}
